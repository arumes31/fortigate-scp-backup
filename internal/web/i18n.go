...
var uiMsgs = map[string]map[string]string{
	...
	"topo.workspace":               {"en": "Network workspace", "de": "Netzwerk-Arbeitsbereich"},
	"topo.explore":                 {"en": "Explore topology", "de": "Topologie erkunden"},
	"topo.search":                  {"en": "Search", "de": "Suchen"},
	"topo.view":                    {"en": "View", "de": "Ansicht"},
	"topo.data":                    {"en": "Data", "de": "Daten"},
	"topo.data_hint":               {"en": "Refresh the optional device layer or keep it live for ten minutes.", "de": "Optionale Gerätedaten aktualisieren oder zehn Minuten live halten."},
	"topo.tools":                   {"en": "Secondary tools", "de": "Weitere Werkzeuge"},
	"topo.tools_hint":              {"en": "Share this view or inspect its requests.", "de": "Ansicht teilen oder ihre Abfragen prüfen."},
	"topo.legend":                  {"en": "Legend", "de": "Legende"},
	"topo.legend_firewall":         {"en": "Firewall", "de": "Firewall"},
	"topo.legend_network":          {"en": "Network / route", "de": "Netz / Route"},
	"topo.legend_switch":           {"en": "Switch / access point", "de": "Switch / Access Point"},
	"topo.legend_client":           {"en": "Client device", "de": "Client-Gerät"},
	"topo.canvas":                  {"en": "Interactive network topology graph", "de": "Interaktiver Netzwerk-Topologiegraph"},
	"topo.close":                   {"en": "Close", "de": "Schließen"},
	"topo.filter_devices":          {"en": "Filter devices", "de": "Geräte filtern"},
	"topo.face_width":              {"en": "Widen or restore faceplate", "de": "Frontblende verbreitern oder zurücksetzen"},
	"topo.face_close":              {"en": "Close faceplate", "de": "Frontblende schließen"},
	...
	"topo.share_open":              {"en": "Share", "de": "Teilen"},
	"topo.share_title":             {"en": "Share topology", "de": "Topologie teilen"},
	"topo.share_hint":              {"en": "Create a revocable public read-only link for the selected firewall.", "de": "Widerrufbaren öffentlichen Nur-Lese-Link für die gewählte Firewall erstellen."},
	"topo.share_expiry":            {"en": "Link expires after", "de": "Link läuft ab nach"},
	"topo.share_created":           {"en": "New public link", "de": "Neuer öffentlicher Link"},
	"topo.share_active":            {"en": "Active links", "de": "Aktive Links"},
	"topo.share_none":              {"en": "No active links for this firewall.", "de": "Keine aktiven Links für diese Firewall."},
	"topo.share_revoked":           {"en": "Link revoked.", "de": "Link widerrufen."},
	"topo.share_created_ok":        {"en": "Public link created.", "de": "Öffentlicher Link erstellt."},
	"topo.share_load_fail":         {"en": "Active links could not be loaded.", "de": "Aktive Links konnten nicht geladen werden."},
	...
	"topo.skip":                    {"en": "Skip to topology", "de": "Zur Topologie springen"},
	"topo.shared_access":           {"en": "Access", "de": "Zugriff"},
	"topo.shared_readonly":         {"en": "Read-only public view", "de": "Öffentliche Nur-Lese-Ansicht"},
	"topo.shared_readonly_hint":    {"en": "This link cannot change firewall data or settings.", "de": "Dieser Link kann keine Firewall-Daten oder Einstellungen ändern."},
	"topo.shared_expiry":           {"en": "Availability", "de": "Verfügbarkeit"},
	"topo.shared_expires":          {"en": "Expires", "de": "Läuft ab"},
	"topo.shared_never":            {"en": "Does not expire", "de": "Läuft nicht ab"},
	"topo.shared_expiry_hint":      {"en": "The owner can revoke this link at any time.", "de": "Der Eigentümer kann diesen Link jederzeit widerrufen."},
	"topo.shared_data":             {"en": "Included data", "de": "Enthaltene Daten"},
	"topo.shared_devices_on":       {"en": "Live client devices included", "de": "Live-Clientgeräte enthalten"},
	"topo.shared_devices_on_hint":  {"en": "Client names, IP and MAC addresses may be visible.", "de": "Client-Namen sowie IP- und MAC-Adressen können sichtbar sein."},
	"topo.shared_devices_off":      {"en": "Network structure only", "de": "Nur Netzwerkstruktur"},
	"topo.shared_devices_off_hint": {"en": "Client device inventory is not exposed by this link.", "de": "Das Client-Geräteinventar wird über diesen Link nicht freigegeben."},
	"topo.shared_footer":           {"en": "Public read-only topology", "de": "Öffentliche Nur-Lese-Topologie"},
	...
	"lic.note":                  {"en": "Collected daily per device via SSH (get system status, diagnose autoupdate versions). Covers FortiGuard service entitlements. These commands do not expose the FortiCare hardware/support contract. HA clusters report the primary's serial.", "de": "Täglich pro Gerät via SSH erfasst (get system status, diagnose autoupdate versions). Umfasst FortiGuard-Dienstlizenzen. Der FortiCare-Hardware-/Support-Vertrag ist über diese Kommandos nicht auslesbar. HA-Cluster melden die Seriennummer des Primary."},
	"lic.inventory":             {"en": "Devices", "de": "Geräte"},
	"lic.filter_group":          {"en": "License status filters", "de": "Lizenzstatus-Filter"},
	"lic.filter_all":            {"en": "All", "de": "Alle"},
	"lic.filter_expiring":       {"en": "Expiring", "de": "Ablaufend"},
	"lic.filter_expired":        {"en": "Expired", "de": "Abgelaufen"},
	"lic.filter_unknown":        {"en": "Unknown", "de": "Unbekannt"},
	"lic.search_label":          {"en": "Search licenses", "de": "Lizenzen durchsuchen"},
	"lic.search":                {"en": "Search licenses…", "de": "Lizenzen durchsuchen…"},
	"lic.count_suffix":          {"en": "devices", "de": "Geräte"},
	"lic.last_refresh":          {"en": "Last successful refresh", "de": "Letzte erfolgreiche Aktualisierung"},
	"lic.never_refreshed":       {"en": "No successful refresh yet", "de": "Noch keine erfolgreiche Aktualisierung"},
	"lic.refreshing":            {"en": "Refreshing", "de": "Aktualisierung"},
	"lic.of":                    {"en": "of", "de": "von"},
	"lic.status_unavailable":    {"en": "Refresh status unavailable. Retrying.", "de": "Aktualisierungsstatus nicht verfügbar. Neuer Versuch folgt."},
	...
	"ipam.empty":                {"en": "No prefixes found. Update the snapshot or adjust the filters.", "de": "Keine Präfixe gefunden. Snapshot aktualisieren oder Filter anpassen."},
	"ipam.filters":              {"en": "Prefix workspace", "de": "Präfix-Arbeitsbereich"},
	"ipam.search_label":         {"en": "Search prefixes", "de": "Präfixe durchsuchen"},
	"ipam.mode_group":           {"en": "Search mode", "de": "Suchmodus"},
	"ipam.mode_text":            {"en": "Text mode", "de": "Textmodus"},
	"ipam.mode_ip":              {"en": "IP address mode", "de": "IP-Adressmodus"},
	"ipam.filter_firewall":      {"en": "Firewall", "de": "Firewall"},
	"ipam.filter_vdom":          {"en": "VDOM", "de": "VDOM"},
	"ipam.filter_all":           {"en": "All", "de": "Alle"},
	"ipam.filter_source":        {"en": "Source", "de": "Quelle"},
	"ipam.source_all":           {"en": "All sources", "de": "Alle Quellen"},
	"ipam.source_interfaces":    {"en": "Interfaces", "de": "Interfaces"},
	"ipam.source_routes":        {"en": "Routes", "de": "Routen"},
	"ipam.source_dhcp":          {"en": "DHCP", "de": "DHCP"},
	"ipam.source_addresses":     {"en": "Addresses", "de": "Adressen"},
	"ipam.active_filters":       {"en": "Active filters", "de": "Aktive Filter"},
	"ipam.remove_filter":        {"en": "Remove", "de": "Entfernen"},
	"ipam.export_csv":           {"en": "Export filtered CSV", "de": "Gefilterte CSV exportieren"},
	"ipam.matches":              {"en": "matches", "de": "Treffer"},
	"ipam.of":                   {"en": "of", "de": "von"},
	"ipam.invalid_ip":           {"en": "Enter one complete IPv4 address.", "de": "Eine vollständige IPv4-Adresse eingeben."},
	"ipam.overlap_context":      {"en": "Matching source context", "de": "Passender Quellkontext"},
	"ipam.no_filtered_overlaps": {"en": "No overlaps match the active filters.", "de": "Keine Überschneidungen passen zu den aktiven Filtern."},
